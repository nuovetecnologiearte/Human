 ...
 function prelevaImg(){
    ...
    var url = 'http://api.reddit.com/new';
    //  document.getElementById('hideAfterClick').style.display='none';
      ...
      request.onload = function() {
        ...
        // Success!
          ...
          console.log(data);
          arrayImmagini = data.data.children;
  ...
  function updateDiv(){
    if (count < arrayImmagini.length ){
      document.getElementById('image' + Math.floor(Math.random()*9)).innerHTML='<img src="'+arrayImmagini[count].data.thumbnail+'">';
      count++;
      setTimeout(updateDiv, 1000);
    }
    else {
